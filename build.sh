...
i686-elf-gcc -c drivers/vga.c -o build/obj/drivers/vga.c.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra -I ./ -I libs
i686-elf-gcc -c kernel/tty.c -o build/obj/kernel/tty.c.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra -I ./ -I libs
i686-elf-gcc -c kernel/kmain.c -o build/obj/kernel/kmain.c.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra -I ./ -I libs
