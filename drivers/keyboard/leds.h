...
============================================================= FILE INFORMATION =============================================================
                 ...
                 .@@@@@@@@@@@@@@@@@@@@@@@@@@%               
           @@@@@@@@@@@@@#             %@@@@@@@@@@@@@        File name & path:           /drivers/keyboard/leds.h
           @@@@@@@@@@@@@#             %@@@@@@@@@@@@@        Programming language:       C (header)
           @@@@@@@@@@@@@#             %@@@@@@@@@@@@@        File usage:                 Declarations of keyboard LED indicators driver
           @@@@@@@@@@@@@#             %@@@@@@@@@@@@@                                    functions
    @@@@@@@@@@@@@&                          ,@@@@@@@        Last revision:              13-06-2023, 13-16 UTC
...
#ifndef _CB_KBD_LEDS_H_
#define _CB_KBD_LEDS_H_
